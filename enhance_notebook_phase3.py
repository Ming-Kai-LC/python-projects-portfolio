...
for i, cell in enumerate(nb['cells']):
    if cell['cell_type'] == 'code':
        ...
        if 'def get_fundamentals(ticker)' in source_text and 'get_fundamentals() function created' in source_text:
...
for i, cell in enumerate(nb['cells']):
    if cell['cell_type'] == 'code':
        source_text = ''.join(cell['source']) if isinstance(cell['source'], list) else cell['source']
        if 'def screen_stocks(df' in source_text and 'screen_stocks() function created' in source_text:
