...
def create_module_01_notebooks():
    ...
    cells1.append(nbf.v4.new_markdown_cell("""# Module 01: Past Continuous Formation - Phase 1: Introduction
...
**Estimated Time:** 120-150 minutes"""))
    ...
    sections = [
        ("1. Introduction to Past Continuous", "The past continuous describes actions that were in progress at a specific time in the past."),
        ("2. Formation - Affirmative", "Structure: Subject + was/were + verb-ing\nI/he/she/it was working\nYou/we/they were working"),
        ("3. Formation - Negative", "Structure: Subject + wasn't/weren't + verb-ing\nI wasn't sleeping\nThey weren't studying"),
        ("4. Formation - Questions", "Structure: Was/Were + subject + verb-ing?\nWas she cooking?\nWere they playing?"),
        ("5. Short Answers", "Yes, I was. / No, I wasn't.\nYes, they were. / No, they weren't."),
        ("6. Spelling Rules for -ing", "Regular: work → working\nDrop -e: make → making\nDouble consonant: run → running\nChange -ie to -y: lie → lying"),
        ("7. Time Expressions", "at 8 o'clock yesterday, this time last week, at that moment, while, when, all morning/afternoon/evening/night/day"),
        ("8. Uses - Actions in Progress", "I was reading at 9 PM yesterday.\nThey were sleeping when you called."),
        ("9. Uses - Parallel Actions", "While I was cooking, he was cleaning.\nShe was studying while her brother was watching TV."),
        ("10. Uses - Background in Stories", "It was raining. People were walking quickly.\nThe sun was shining and birds were singing."),
        ("11. Common Mistakes", "❌ I was work (missing -ing)\n❌ They was playing (wrong 'be' form)\n❌ I were watching (wrong 'be' form)\n✓ I was working\n✓ They were playing\n✓ I was watching"),
        ("12. Contractions", "I was → I was (no contraction in affirmative)\nI was not → I wasn't\nWe were not → We weren't\nNote: Contractions mainly in negative forms"),
        ("13. Practice Conversations", "A: What were you doing at 8 PM yesterday?\nB: I was watching a movie.\nA: Were you alone?\nB: No, I wasn't. My friend was with me.")
    ]

    for title, content in sections:
        cells1.append(nbf.v4.new_markdown_cell(f"""## {title}
...
- Use were with: you, we, they"""))
        ...
        cells1.append(nbf.v4.new_code_cell(f"""# {title} - Practice
print("{title}")
print("=" * 60)
...
print("\\nYour turn: Create 5 sentences using past continuous")"""))
    ...
    cells2.append(nbf.v4.new_markdown_cell("""# Module 01: Past Continuous Formation - Phase 2: Controlled Practice
...
**Total: 80 exercises** *(Enhanced for stronger grammar foundation)*"""))
    ...
    for set_name, count, description in exercise_sets:
        cells2.append(nbf.v4.new_markdown_cell(f"""## Exercise Set: {set_name} ({count} exercises)
...
"""))
        ...
        cells2.append(nbf.v4.new_code_cell(f"""# {set_name} Exercises
...
print("\\n[Answers and explanations provided at end of notebook]")"""))
    ...
    cells3.append(nbf.v4.new_markdown_cell("""# Module 01: Past Continuous Formation - Phase 3: Meaningful Practice
...
10. Background for a Story"""))
    ...
    activities = [
        ...
        ("My Morning Routine Yesterday", "Describe what you were doing during different parts of yesterday morning"),
    ...
    for i, (activity_name, description) in enumerate(activities, 1):
        cells3.append(nbf.v4.new_markdown_cell(f"""## Activity {i}: {activity_name}
...
Yesterday at 8 PM, I was watching a movie. My sister wasn't studying; she was cooking dinner..."""))
        ...
        cells3.append(nbf.v4.new_code_cell(f"""# Activity {i}: {activity_name}
print("{activity_name}")
print("=" * 60)
print("\\n{description}")
print()
...
print("\\nShare with a partner and compare your activities!")"""))
    ...
    cells4.append(nbf.v4.new_markdown_cell("""# Module 01: Past Continuous Formation - Phase 4: Communicative Practice
...
8. News Reporter Simulation"""))
    ...
    tasks = [
        ("Interview: What Were You Doing?", "Interview 3 classmates about what they were doing at different times yesterday"),
        ("Alibi Role-Play", "Student A: Detective, Student B: Suspect (What were you doing at 8 PM last night?)"),
        ("Picture Description", "Describe a picture showing people doing various activities in the past"),
        ("Story Building", "Create a collaborative story, each person adding past continuous sentences"),
        ("Find Someone Who Was...", "Walk around and find classmates who were doing specific activities"),
        ("Timeline Activity", "Draw a timeline of your day yesterday and explain what you were doing"),
        ("Spot the Difference (Actions)", "Compare two pictures and describe what people were doing differently"),
    ...
    for i, (task_name, description) in enumerate(tasks, 1):
        cells4.append(nbf.v4.new_markdown_cell(f"""## Task {i}: {task_name}
...
- Yes, I was. / No, I wasn't."""))
        ...
        cells4.append(nbf.v4.new_code_cell(f"""# Task {i}: {task_name}
print("{task_name}")
print("=" * 60)
print("\\n{description}")
print("\\nUseful questions:")
...
def create_module_02_notebooks():
    ...
    cells1.append(nbf.v4.new_markdown_cell("""# Module 02: Past Continuous vs Past Simple - Phase 1: Introduction
...
**Prerequisites:** Past Simple, Past Continuous Formation"""))
    ...
    sections = [
        ("1. Review: Past Simple", "Used for completed actions in the past\nI watched TV yesterday.\nShe finished her work."),
        ("2. Review: Past Continuous", "Used for actions in progress at a specific time\nI was watching TV at 8 PM.\nShe was working when I called."),
        ("3. Key Difference", "Past Simple: Complete action\nPast Continuous: Action in progress (duration)"),
        ("4. When to Use Past Simple", "Completed actions, sequences of events, permanent situations in the past"),
        ("5. When to Use Past Continuous", "Actions in progress, temporary situations, background in stories, interrupted actions"),
        ("6. Combining Both Tenses", "When + Past Simple, Past Continuous\nI was sleeping when the phone rang.\nWhile I was cooking, someone knocked on the door."),
        ("7. Time Markers - Past Simple", "yesterday, last week, ago, in 2020, then, suddenly"),
        ("8. Time Markers - Past Continuous", "at 8 o'clock, while, when, at that moment, all day, this time last week"),
        ("9. Parallel Actions", "While I was studying, she was cooking. (both past continuous)"),
        ("10. Interrupted Actions", "I was reading when the phone rang. (continuous interrupted by simple)"),
        ("11. Common Mistakes", "❌ I watched TV when she called (should be: I was watching)\n❌ When she called, I was answer (should be: I answered)\n❌ While I watched, she came (should be: I was watching)"),
        ("12. Sequences vs Background", "Simple for sequence: I woke up, had breakfast, and went to work.\nContinuous for background: The sun was shining. People were walking."),
        ("13. Practice in Context", "Complete dialogues and stories using both tenses appropriately")
    ]
...
print("\\nPractice: Write sentences using both tenses")"""))
    ...
    cells2.append(nbf.v4.new_markdown_cell("""# Module 02: Past Continuous vs Past Simple - Phase 2: Controlled Practice
...
**Total: 85 exercises** *(Enhanced for stronger grammar foundation)*"""))
    ...
    exercise_sets = [
        ("Tense Identification", 10, "Identify whether past simple or past continuous should be used"),
...
print("\\n[Answers with explanations at end of notebook]")"""))
    ...
    # Phase 3
    nb3 = nbf.v4.new_notebook()
    nb3['cells'] = [nbf.v4.new_markdown_cell("# Module 02: Past Continuous vs Past Simple - Phase 3: Meaningful Practice\n\n10 activities applying both tenses")]
    for i in range(10):
        nb3['cells'].append(nbf.v4.new_markdown_cell(f"## Activity {i+1}\n\nMeaningful practice activity"))
    ...
    # Phase 4
    nb4 = nbf.v4.new_notebook()
    nb4['cells'] = [nbf.v4.new_markdown_cell("# Module 02: Past Continuous vs Past Simple - Phase 4: Communicative Practice\n\n8 communicative tasks")]
    for i in range(8):
...
def create_module_03_notebooks():
    ...
    for phase_num, phase_name in [(1, "Introduction"), (2, "Controlled Practice"), (3, "Meaningful Practice"), (4, "Communicative Practice")]:
        nb = nbf.v4.new_notebook()
        nb['cells'] = [nbf.v4.new_markdown_cell(f"# Module 03: Past Continuous for Interrupted Actions - Phase {phase_num}: {phase_name}")]

        num_sections = 13 if phase_num == 1 else (85//10 if phase_num == 2 else (10 if phase_num == 3 else 8))
        for i in range(num_sections):
            nb['cells'].append(nbf.v4.new_markdown_cell(f"## Section {i+1}\n\nContent for {phase_name}"))
...
def create_module_04_notebooks():
    ...
    for phase_num, phase_name in [(1, "Introduction"), (2, "Controlled Practice"), (3, "Meaningful Practice"), (4, "Communicative Practice")]:
        nb = nbf.v4.new_notebook()
        nb['cells'] = [nbf.v4.new_markdown_cell(f"# Module 04: Present Perfect - Life Experiences - Phase {phase_num}: {phase_name}")]

        num_sections = 13 if phase_num == 1 else (80//10 if phase_num == 2 else (10 if phase_num == 3 else 8))
        for i in range(num_sections):
            nb['cells'].append(nbf.v4.new_markdown_cell(f"## Section {i+1}\n\nContent for {phase_name}"))
            nb['cells'].append(nbf.v4.new_code_cell(f"# Section {i+1}\nprint('Section {i+1}')"))
...
def create_module_05_notebooks():
    ...
    for phase_num, phase_name in [(1, "Introduction"), (2, "Controlled Practice"), (3, "Meaningful Practice"), (4, "Communicative Practice")]:
        nb = nbf.v4.new_notebook()
        nb['cells'] = [nbf.v4.new_markdown_cell(f"# Module 05: Present Perfect with Ever/Never - Phase {phase_num}: {phase_name}")]
