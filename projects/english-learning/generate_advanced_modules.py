...
ADVANCED_MODULES = {
    "Module_12": {
        ...
        "topics": ["CAN for ability", "CAN'T for inability", "Questions with CAN", "CAN for permission", "Requests and offers"],
        "exercises_count": 60
    },
    "Module_13": {
        ...
        "topics": ["This/That for singular near/far", "These/Those for plural", "Using with nouns", "Asking questions"],
        "exercises_count": 50
    },
    "Module_14": {
        ...
        "topics": ["Like/Love/Hate + -ing", "Prefer/Enjoy + -ing", "Don't like/Don't mind", "Talking about hobbies"],
        "exercises_count": 55
    },
    "Module_15": {
        ...
        "topics": ["Was/Were affirmative", "Was/Were negative (wasn't/weren't)", "Questions with was/were", "Time expressions"],
        "exercises_count": 58
    },
    "Module_16": {
        ...
        "topics": ["Adding -ed", "Pronunciation of -ed", "Spelling rules", "Time expressions (yesterday, last week)"],
        "exercises_count": 65
    },
    "Module_17": {
        ...
        "topics": ["50 common irregular verbs", "Go→went, See→saw, etc.", "Past questions and negatives", "Storytelling"],
        "exercises_count": 70
    },
    "Module_18": {
        ...
        "topics": ["Going to + verb", "Future plans", "Predictions based on evidence", "Questions and negatives"],
        "exercises_count": 60
    },
    "Module_19": {
        "title": "Will Future",
        ...
        "topics": ["Will/Won't", "Spontaneous decisions", "Promises and offers", "Will vs Going to"],
        "exercises_count": 62
    },
    "Module_20": {
        ...
        "topics": ["Always, usually, often, sometimes, rarely, never", "Position in sentence", "How often questions", "Frequency expressions"],
        "exercises_count": 55
    }
}
