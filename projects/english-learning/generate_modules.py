...
def generate_module(module_num, module_data, base_path):
    ...
    notebooks = {
        ...
        "02_controlled_practice.ipynb": create_controlled_practice_notebook(module_num, module_data),
        "03_meaningful_practice.ipynb": create_meaningful_practice_notebook(module_num, module_data),
        "04_communicative_practice.ipynb": create_communicative_practice_notebook(module_num, module_data)
    }
