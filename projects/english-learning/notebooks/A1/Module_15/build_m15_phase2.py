...
def build_phase2_notebook():
    ...
    # Title
    cells.append(create_cell("markdown", """# Module 15: Past Simple - Was/Were - Controlled Practice
...
print("✅ Setup complete! Let's practice WAS and WERE!")""", f"cell-{cell_counter}"))
    cell_counter += 1
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Exercise Set 7: There Was/Were (10 exercises)
