"""
Builder script for Module 15 Phase 4: Past Simple - Was/Were - Communicative Practice
...
def build_phase4_notebook():
    ...
    # Title
    cells.append(create_cell("markdown", """# Module 15: Past Simple - Was/Were - Communicative Practice

## 📚 Phase 4: Communicative Practice (25% of learning time)

**Welcome to Communicative Practice!** 🗣️

In this final phase, you'll use WAS and WERE in **real-world communication tasks**. These activities simulate authentic conversations and situations.
...
2. **Middle:** What happened (use was/were for descriptions)
...
- Where you were
- Who you were with
- What you did (use was/were for states)
- How the weather was
- How you felt
...
## 🎉 Congratulations! Module 15 Complete!

You've successfully completed all four phases of **Past Simple - Was/Were**!
...
if __name__ == "__main__":
    ...
    print(f"Module 15 Phase 4 notebook created successfully!")
