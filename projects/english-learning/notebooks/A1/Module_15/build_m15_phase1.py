"""
Builder script for Module 15 Phase 1: Past Simple - Was/Were - Introduction
...
def build_phase1_notebook():
    ...
    cells.append(create_cell("markdown", """# Module 15: Past Simple - Was/Were - Introduction
...
print("✅ Setup complete! Let's learn about WAS and WERE!")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 2: Section 1 - Introduction to Past Simple with Was/Were
    cells.append(create_cell("markdown", """## 1. Introduction to Past Simple with Was/Were ⏰
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Past Simple examples
audio.play_audio("I was at school yesterday.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("They were very happy.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She was my teacher.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 6: Section 2 - Was/Were Forms and Usage
    cells.append(create_cell("markdown", """## 2. Was/Were - Forms and Usage 📝
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 3. Affirmative Sentences (Positive Statements) ✅
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Affirmative sentence examples
audio.play_audio("I was happy yesterday.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She was at the library.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("We were best friends.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 11: Section 4 - Negative Sentences
    cells.append(create_cell("markdown", """## 4. Negative Sentences 🚫
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Negative sentence examples
audio.play_audio("I wasn't at school yesterday.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("They weren't happy about the news.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She wasn't my teacher.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 15: Section 5 - Questions
    cells.append(create_cell("markdown", """## 5. Questions with Was/Were ❓
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Question examples
audio.play_audio("Were you at home yesterday?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Where was she last night?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("How was your weekend?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 19: Section 6 - Short Answers
    cells.append(create_cell("markdown", """## 6. Short Answers 👍👎
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Short answer conversation
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """## 7. Time Expressions with Past Simple 📅
...
```
Subject + was/were + complement + TIME EXPRESSION
```
...
```
TIME EXPRESSION, subject + was/were + complement
```
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Time expression examples
audio.play_audio("I was at the cinema last night.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She was here two hours ago.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("They were in Paris last summer.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 26: Section 8 - Common Uses
    cells.append(create_cell("markdown", """## 8. Common Uses of Was/Were 🎯
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Common uses examples
audio.play_audio("The weather was beautiful yesterday.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("I was a teacher ten years ago.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("The movie was very interesting.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 30: Section 9 - There was/There were
    cells.append(create_cell("markdown", """## 9. There Was / There Were 🔍
...
### Structure:
```
There was/were + noun + (location/time)
```
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# There was/were examples
audio.play_audio("There was a problem with my computer.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("There were many people at the concert.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Were there any messages for me?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 34: Section 10 - Common Mistakes
    cells.append(create_cell("markdown", """## 10. Common Mistakes to Avoid ⚠️
...
**Remember:** Use "wasn't" or "weren't" (not "not was/were")
...
### Mistake 5: Using "to be" after was/were
❌ I was **to be** tired. → ✅ I was tired.
❌ She was **to be** happy. → ✅ She was happy.

### Mistake 6: Confusing there was/were with they were
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 11. Practice Conversations 🗣️

### Conversation 1: Talking About Yesterday</cell>""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation about yesterday
audio.create_conversation_audio([
    ...
    # Conversation 2
    cells.append(create_cell("markdown", """### Conversation 2: Asking About the Past</cell>""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation asking about the past
audio.create_conversation_audio([
    ...
    # Conversation 3
    cells.append(create_cell("markdown", """### Conversation 3: There Was/Were</cell>""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation using there was/were
audio.create_conversation_audio([
    ...
    # Conversation 4
    cells.append(create_cell("markdown", """### Conversation 4: Describing the Past</cell>""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation describing the past
audio.create_conversation_audio([
...
Now that you understand WAS and WERE, it's time to practice!

### Continue to:
1. **02_controlled_practice.ipynb** - 70+ exercises on was/were
...
if __name__ == "__main__":
    ...
    print(f"Module 15 Phase 1 notebook created successfully!")
