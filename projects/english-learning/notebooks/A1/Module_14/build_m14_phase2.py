...
def build_phase2_notebook():
    ...
    cells.append(create_cell("markdown", """# Module 14: Like, Love, Hate + -ing - Controlled Practice
...
---""", f"cell-{cell_counter}"))
    ...
    for prompt, answer in exercises_set9:
        cells.append(create_cell("code", f"""# Exercise 9.{exercises_set9.index((prompt, answer)) + 1}
exercise.create_fill_in_blank(
    "{prompt}",
    "{answer}"
)""", f"cell-{cell_counter}"))
...
---""", f"cell-{cell_counter}"))
    ...
    exercises_set10 = [
        ...
        ("2. A: Do you want to go shopping? B: Not really. I ___ (shop). [strong negative]", "hate shopping"),
        ("3. A: Can you help me? B: Sure! I ___ (help) people. [neutral/willing]", "don't mind helping"),
        ("4. A: What's your passion? B: I ___ (paint)! It's amazing! [strong positive]", "love painting"),
        ("5. A: Do you like coffee or tea? B: I ___ (drink) tea. [comparison implied]", "prefer drinking"),
        ("6. A: How do you relax? B: I ___ (read) novels. [active pleasure]", "enjoy reading"),
        ("7. A: What's the worst chore? B: I absolutely ___ (clean) the bathroom! [extreme negative]", "hate cleaning"),
        ("8. A: What do you do on weekends? B: I ___ (spend) time with family. [positive]", "like spending"),
    ]
...
def main():
    ...
    # Count exercises
    exercise_count = sum(1 for cell in notebook['cells']
                        if cell['cell_type'] == 'code'
                        and 'exercise.create' in str(cell.get('source', '')))
    ...
    if 25 <= file_size_kb <= 30:
        ...
        print(f"⚠️ File size is outside target range. Target: 25-30 KB, Actual: {file_size_kb:.2f} KB")
