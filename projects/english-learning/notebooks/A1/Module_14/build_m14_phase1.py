...
def build_phase1_notebook():
    ...
    cells.append(create_cell("markdown", """# Module 14: Like, Love, Hate + -ing - Introduction
...
print("[OK] Setup complete! Let's learn about expressing preferences with -ing!")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 2: Section 1 - Introduction to Expressing Preferences
    cells.append(create_cell("markdown", """## 1. Introduction to Expressing Preferences 💬
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 2. LIKE + -ing (Expressing Positive Preferences) 👍
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# LIKE + -ing - Examples with audio
audio.play_audio("I like reading books in my free time.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She likes watching movies on weekends.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("They like playing football after school.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("We like going to the beach in summer.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 8: Section 3 - LOVE + -ing
    cells.append(create_cell("markdown", """## 3. LOVE + -ing (Expressing Strong Positive Feelings) ❤️
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# LOVE + -ing - Examples with audio
audio.play_audio("I love dancing at parties!", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She loves traveling to new countries.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("They love cooking Italian food together.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("We love spending time with our family.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 13: Section 4 - HATE + -ing
    cells.append(create_cell("markdown", """## 4. HATE + -ing (Expressing Strong Negative Feelings) 😠
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# HATE + -ing - Examples with audio
audio.play_audio("I hate waiting in long lines.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She hates waking up early on Mondays.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("They hate cleaning the house.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("We hate being late for meetings.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 18: Section 5 - Other Preference Verbs
    cells.append(create_cell("markdown", """## 5. Other Preference Verbs (Enjoy, Prefer, Don't Mind) 🎯
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# ENJOY - Examples with audio
audio.play_audio("I enjoy reading mystery novels.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She enjoys playing tennis every weekend.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# PREFER - Examples with audio
audio.play_audio("I prefer walking to driving.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("They prefer staying home to going out.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# DON'T MIND - Examples with audio
audio.play_audio("I don't mind waiting a few minutes.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 24: Section 6 - Forming the -ing Verb
    cells.append(create_cell("markdown", """## 6. Forming the -ing Verb (Gerund Spelling Rules) ✍️
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Display spelling rules visual aid
display(HTML('''
...
'''))""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 7. Negative Forms (Don't Like, Don't Love) ❌
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Negative forms - DON'T LIKE
audio.play_audio("I don't like waking up early on Mondays.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She doesn't like waiting in long lines.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Negative forms - DON'T ENJOY
audio.play_audio("They don't enjoy doing homework.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("He doesn't enjoy commuting to work every day.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 31: Section 8 - Questions
    cells.append(create_cell("markdown", """## 8. Questions (Do you like...? What do you like...?) ❓
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Questions - Yes/No
audio.play_audio("Do you like reading books?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1
    ...
    cells.append(create_cell("code", """# Questions - What
audio.play_audio("What do you like doing in your free time?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1
    ...
    cells.append(create_cell("code", """# Questions - Which (preference)
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """## 9. Common Collocations (Natural Combinations) 🔗
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Display common collocations chart
display(HTML('''
...
'''))""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 10. Talking About Hobbies and Free Time 🎨
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Hobbies conversation 1
audio.create_conversation_audio([
    ("Person A", "What do you like doing in your free time?"),
    ...
    cells.append(create_cell("code", """# Hobbies conversation 2
audio.create_conversation_audio([
    ...
    cells.append(create_cell("code", """# Hobbies conversation 3
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """## 11. Common Mistakes to Avoid ⚠️
...
### Conversation 1: First Meeting at a Party 🎉""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 1: First meeting
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 2: Weekend Plans 📅""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 2: Weekend plans
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 3: Job Interview 💼""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 3: Job interview
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 4: Dating Conversation 💑""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 4: Dating
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 5: Roommate Discussion 🏠""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 5: Roommates
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 6: Fitness Center Conversation 🏃""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 6: Fitness center
audio.create_conversation_audio([
...
def main():
    ...
    if 18 <= file_size_kb <= 22:
        ...
        print(f"⚠️ File size is outside target range. Target: 18-22 KB, Actual: {file_size_kb:.2f} KB")
