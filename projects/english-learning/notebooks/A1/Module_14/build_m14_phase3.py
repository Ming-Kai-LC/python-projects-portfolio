...
def build_phase3_notebook():
    ...
    cells.append(create_cell("markdown", """# Module 14: Like, Love, Hate + -ing - Meaningful Practice
...
print("💡 Remember: There are no wrong answers - just express yourself honestly!")""", f"cell-{cell_counter}"))
    cell_counter += 1
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 1: Write about your hobbies
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 2: Free time activities
activity.create_writing_prompt(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 3: Things you don't like
activity.create_writing_prompt(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 4: Interview exercise
activity.create_writing_prompt(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 5: Compare preferences
activity.create_writing_prompt(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 6: Different situations
activity.create_writing_prompt(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 7: New activities
activity.create_writing_prompt(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 8: Changed preferences
activity.create_writing_prompt(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 9: Weather and seasons
activity.create_writing_prompt(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Activity 10: Ideal weekend
activity.create_writing_prompt(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Reflection activity
activity.create_writing_prompt(
...
Open **04_communicative_practice.ipynb** to continue.""", f"cell-{cell_counter}"))
    cell_counter += 1
...
def main():
    ...
    # Count activities
    activity_count = sum(1 for cell in notebook['cells']
                        if cell['cell_type'] == 'code'
                        and 'activity.create' in str(cell.get('source', '')))
    ...
    if 16 <= file_size_kb <= 20:
        ...
        print(f"⚠️ File size is outside target range. Target: 16-20 KB, Actual: {file_size_kb:.2f} KB")
