...
def build_phase4_notebook():
    ...
    cells.append(create_cell("markdown", """# Module 14: Like, Love, Hate + -ing - Communicative Practice
...
print("🎭 Try to practice these conversations out loud with a partner if possible!")""", f"cell-{cell_counter}"))
    cell_counter += 1
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Task 1: First date conversation
task.create_dialogue_task(
    ...
    cells.append(create_cell("code", """# Example first date conversation (listen first for inspiration)
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Task 2: Planning with friends
task.create_dialogue_task(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Task 3: Roommate conversation
task.create_dialogue_task(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Task 4: Job interview
task.create_dialogue_task(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Task 5: Gym/fitness discussion
task.create_dialogue_task(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Task 6: Travel planning
task.create_dialogue_task(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Task 7: Social media post
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Task 8: Parent-child conversation
task.create_dialogue_task(
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Final reflection
task.create_writing_task(
...
def main():
    ...
    # Count tasks
    task_count = sum(1 for cell in notebook['cells']
                    if cell['cell_type'] == 'code'
                    and 'task.create' in str(cell.get('source', '')))
