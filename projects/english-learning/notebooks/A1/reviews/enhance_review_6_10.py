...
def create_review_notebook():
    ...
    cells.append(nbf.v4.new_markdown_cell("""# A1 Review: Modules 6-10
...
---"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 1: Nouns and Plurals (10 questions)

Complete with the correct singular or plural form."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.1: Nouns and Plurals
exercises_1_1 = [
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 2: Possessives (10 questions)

Use 's or of to show possession."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.2: Possessives
exercises_1_2 = [
    create_fill_in_blank(
        "This is my ___ car.",
        answer="father's",
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 3: Adjectives (10 questions)

Choose the correct adjective to describe each noun."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.3: Adjectives
exercises_1_3 = [
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 4: There Is/Are (10 questions)

Choose 'is' or 'are' based on singular or plural."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.4: There Is/Are
exercises_1_4 = [
    create_multiple_choice(
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 5: Prepositions (10 questions)

Choose the correct preposition for each context."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.5: Prepositions
exercises_1_5 = [
    create_multiple_choice(
        "I live ___ New York.",
        options=["in", "on", "at"],
