...
def create_review_notebook():
    ...
    cells.append(nbf.v4.new_markdown_cell("""# A1 Review: Modules 16-20
...
---"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 1: Past Simple Regular Verbs (10 questions)

Add -ed to create past tense (watch for spelling changes!)."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.1: Past Simple Regular Verbs
exercises_1_1 = [
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 2: Past Simple Irregular Verbs (10 questions)

Use the irregular past form (no -ed!)."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.2: Past Simple Irregular Verbs
exercises_1_2 = [
    create_fill_in_blank(
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 3: Going To Future (10 questions)

Use 'am/is/are going to + verb' for plans and intentions."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.3: Going To Future
exercises_1_3 = [
    create_fill_in_blank(
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 4: Will Future (10 questions)

Use 'will + verb' for predictions, promises, and spontaneous decisions."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.4: Will Future
exercises_1_4 = [
    create_fill_in_blank(
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 5: Adverbs of Frequency (10 questions)

Place adverbs correctly (usually before main verb, after 'be')."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.5: Adverbs of Frequency
exercises_1_5 = [
    create_multiple_choice(
        "I ___ eat breakfast.",
...
---"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Exercise 2.1: Error Correction
exercises_2_1 = [
    create_fill_in_blank(
...
---"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Display Final Score
print("="*60)
