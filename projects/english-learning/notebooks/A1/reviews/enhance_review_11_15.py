...
def create_review_notebook():
    ...
    cells.append(nbf.v4.new_markdown_cell("""# A1 Review: Modules 11-15
...
---"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 1: Question Words (10 questions)

Complete each question with the correct question word."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.1: Question Words
exercises_1_1 = [
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 2: Can/Can't (10 questions)

Complete with 'can' or 'can't' based on the context."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.2: Can/Can't
exercises_1_2 = [
    create_multiple_choice(
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 3: Demonstratives (10 questions)

Choose this/that/these/those based on distance and number."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.3: Demonstratives
exercises_1_3 = [
    create_multiple_choice(
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 4: Like/Love/Hate + -ing (10 questions)

Add -ing to the verb after like/love/hate."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.4: Like/Love/Hate + -ing
exercises_1_4 = [
    create_fill_in_blank(
...
print(f"\\nCurrent Score: {total_score}/{max_score}")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""### Exercise Set 5: Past Simple Was/Were (10 questions)

Choose 'was' or 'were' for past tense."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1.5: Was/Were
exercises_1_5 = [
    create_multiple_choice(
