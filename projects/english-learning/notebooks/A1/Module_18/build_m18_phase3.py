...
def create_notebook():
    ...
    # Title
    cells.append(nbf.v4.new_markdown_cell("""# Module 18: Going To Future - Phase 3: Meaningful Practice
...
**Estimated Time:** 60-90 minutes"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 1: My Future Plans
...
- I'm going to save money for a new laptop."""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 1: Write your future plans
...
for plan_template in your_plans:
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 2: This Weekend
...
- Sunday evening: ..."""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 2: Weekend plans
...
print("  Evening: I'm going to ___________________________________")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 3: Making Predictions
...
**Remember:** Use "going to" for predictions when you have evidence!"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 3: Making predictions
situations = [
    {
...
for i, item in enumerate(situations, 1):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 4: Dream Vacation
...
- Sightseeing (what are you going to visit?)"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 4: Dream vacation plans
...
for i in range(1, 11):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 5: Five-Year Plan
...
- Financial goals"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 5: Five-year plan
...
for category in categories:
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 6: Weather Predictions
...
- windy, foggy, sunny, cloudy"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 6: Weather predictions
...
for day in days:
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 7: My Career Path
...
- How are you going to achieve your goals?"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 7: Career plans
...
for phase in phases:
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 8: Family Activities
...
- Family projects"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 8: Family activities
...
print("   Details: We're going to ______________________________")"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 9: Planning a Party
...
- What music are you going to play?"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 9: Party planning
...
for i in range(1, 6):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Activity 10: New Year's Resolutions
...
- Personal habits"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Activity 10: New Year's resolutions
...
for i, category in enumerate(resolution_categories, 1):
    ...
    # Summary
    cells.append(nbf.v4.new_markdown_cell("""## Phase 3 Complete!
...
Excellent progress! [TARGET]"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Phase 3 summary
summary = {
    "Total activities": 10,
    "Contexts practiced": [
