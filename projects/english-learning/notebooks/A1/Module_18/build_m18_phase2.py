...
def create_notebook():
    ...
    # Title
    cells.append(nbf.v4.new_markdown_cell("""# Module 18: Going To Future - Phase 2: Controlled Practice
...
**Estimated Time:** 90-120 minutes"""))
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 1: Basic Formation (10 exercises)

Form correct sentences using "going to" with the given elements."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 1-10: Form sentences with "going to"
exercises_1_10 = [
...
for i, ex in enumerate(exercises_1_10, 1):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 2: Affirmative to Negative (10 exercises)

Convert the affirmative sentences to negative."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 11-20: Convert to negative
exercises_11_20 = [
...
for i, answer in enumerate(negative_forms, 11):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 3: Form Questions (10 exercises)

Convert the statements to yes/no questions."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 21-30: Form questions
exercises_21_30 = [
...
for i, answer in enumerate(question_forms, 21):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 4: Short Answers (10 exercises)

Provide short answers to these questions (both affirmative and negative)."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 31-40: Short answers
exercises_31_40 = [
    "Are you going to study tonight?",
...
for i, (yes_ans, no_ans) in enumerate(short_answers, 31):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 5: Error Correction (10 exercises)

Find and correct the mistakes in these sentences."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 41-50: Error correction
exercises_41_50 = [
...
for i, (wrong, correct, error_type) in enumerate(corrections, 41):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 6: Gap Filling (10 exercises)

Complete the sentences with the correct form of "going to" and the verb in parentheses."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 51-60: Gap filling
exercises_51_60 = [
...
for i, (question, answer) in enumerate(exercises_51_60, 51):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 7: Wh- Questions (10 exercises)

Form questions using the question words provided."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 61-70: Wh- questions
exercises_61_70 = [
...
for i, (_, answer) in enumerate(exercises_61_70, 61):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 8: Time Expressions (5 exercises)

Add appropriate time expressions to complete the sentences."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 71-75: Time expressions
exercises_71_75 = [
...
for i, (sentence, options) in enumerate(exercises_71_75, 71):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 9: Plans vs Predictions (5 exercises)

Identify whether each sentence expresses a PLAN or a PREDICTION."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 76-80: Plans vs Predictions
exercises_76_80 = [
...
for i, (sentence, answer) in enumerate(exercises_76_80, 76):
    ...
    cells.append(nbf.v4.new_markdown_cell("""## Exercise Set 10: Going To vs Will - Preview (5 exercises)

Choose the better option (going to or will) for each situation."""))

    cells.append(nbf.v4.new_code_cell("""# Exercise 81-85: Going to vs will
exercises_81_85 = [
    {
...
for i, ex in enumerate(exercises_81_85, 81):
    ...
    # Summary
    cells.append(nbf.v4.new_markdown_cell("""## Phase 2 Complete!
...
Great work! [TARGET]"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# Phase 2 summary
summary = {
    "Total exercises": 85,
    "Exercise types": 10,
    "Skills practiced": [
