...
def build_phase1_notebook():
    ...
    cells.append(create_cell("markdown", """# Module 17: Past Simple - Irregular Verbs - Introduction
...
print("✅ Setup complete! Let's learn about Past Simple irregular verbs!")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 2: Section 1 - Introduction to Past Simple with Irregular Verbs
    cells.append(create_cell("markdown", """## 1. Introduction to Past Simple with Irregular Verbs ⏰
...
audio.play_audio("I was at school yesterday.", accent="us")""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 2. Irregular Verbs - Forms and Usage 📝
...
audio.play_audio("I wasn't at school yesterday.", accent="us")""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 5. Questions with Irregular Verbs ❓
...
audio.play_audio("I was at the cinema last night.", accent="us")""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 8. Common Uses of Irregular Verbs 🎯
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# There irregular verbs examples
...
audio.create_conversation_audio([
    ...
    # Conversation 3
    cells.append(create_cell("markdown", """### Conversation 3: There Irregular Verbs</cell>""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation using there irregular verbs
audio.create_conversation_audio([
