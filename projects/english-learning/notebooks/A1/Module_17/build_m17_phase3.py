"""
Builder script for Module 17 Phase 3: Past Simple - Irregular Verbs - Meaningful Practice
...
def build_phase3_notebook():
    ...
    # Title
    cells.append(create_cell("markdown", """# Module 17: Past Simple - Irregular Verbs - Meaningful Practice

## 📚 Phase 3: Meaningful Practice (30% of learning time)

**Welcome to Meaningful Practice!** 🎨

In this phase, you'll use Past Simple irregular verbs to talk about **YOUR OWN** past experiences. These activities are personal and creative!
...
print("✅ Setup complete! Let's practice with YOUR own stories!")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Activity 1
    cells.append(create_cell("markdown", """## Activity 1: My Childhood 👶
...
---""", f"cell-{cell_counter}"))
    ...
    # Activity 2
    cells.append(create_cell("markdown", """## Activity 2: Last Weekend 📅
...
---""", f"cell-{cell_counter}"))
    ...
    # Activity 3
    cells.append(create_cell("markdown", """## Activity 3: My Best Friend in the Past 👫
...
---""", f"cell-{cell_counter}"))
    ...
    # Activity 4
    cells.append(create_cell("markdown", """## Activity 4: A Memorable Day 🌟
...
- Where you were
- Who was there
- What happened (using irregular verbs for states)
- How you felt
...
---""", f"cell-{cell_counter}"))
    ...
    # Activity 5
    cells.append(create_cell("markdown", """## Activity 5: My First School 🏫
...
---""", f"cell-{cell_counter}"))
    ...
    # Activity 6
    cells.append(create_cell("markdown", """## Activity 6: Last Year 📆
...
---""", f"cell-{cell_counter}"))
    ...
    # Activity 7
    cells.append(create_cell("markdown", """## Activity 7: A Place I Visited 🗺️
...
---""", f"cell-{cell_counter}"))
    ...
    # Activity 8
    cells.append(create_cell("markdown", """## Activity 8: How I Was Different ⏪
...
---""", f"cell-{cell_counter}"))
    ...
    # Activity 9
    cells.append(create_cell("markdown", """## Activity 9: My Family in the Past 👨‍👩‍👧‍👦
...
---""", f"cell-{cell_counter}"))
    ...
    # Activity 10
    cells.append(create_cell("markdown", """## Activity 10: A Special Memory 💭
...
---""", f"cell-{cell_counter}"))
    ...
    # Reflection
    cells.append(create_cell("markdown", """## 🎯 Reflection and Self-Assessment
...
---""", f"cell-{cell_counter}"))
    ...
    # Audio Practice
    cells.append(create_cell("markdown", """## 🔊 Read Your Sentences Aloud
...
### Key Achievement:
You've used Past Simple irregular verbs to tell **YOUR OWN STORIES** in English! This is real communication!
...
**Amazing job!** 🌟 Your English is growing stronger!""", f"cell-{cell_counter}"))
    cell_counter += 1
...
if __name__ == "__main__":
    ...
    print(f"Module 17 Phase 3 notebook created successfully!")
