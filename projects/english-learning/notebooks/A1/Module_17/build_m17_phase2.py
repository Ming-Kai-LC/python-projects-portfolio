"""
Builder script for Module 17 Phase 2: Past Simple - Irregular Verbs - Controlled Practice
Target: 70+ exercises covering all aspects of irregular verbs
"""
...
def build_phase2_notebook():
    ...
    # Title
    cells.append(create_cell("markdown", """# Module 17: Past Simple - Irregular Verbs - Controlled Practice

## 📚 Phase 2: Controlled Practice (30% of learning time)

**Welcome to Controlled Practice!** 💪

In this phase, you'll complete **70+ exercises** to master Past Simple irregular verbs. These exercises focus on accuracy and proper form.
...
---""", f"cell-{cell_counter}"))
    ...
    # Setup
    cells.append(create_cell("code", """# Setup
import sys
...
print("✅ Setup complete! Let's practice Past Simple irregular verbs!")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Exercise Set 1: Was vs Were
    cells.append(create_cell("markdown", """## Exercise Set 1: Was vs Were (10 exercises)
...
---""", f"cell-{cell_counter}"))
    ...
    # Answers 1
    cells.append(create_cell("markdown", """### Answers - Exercise Set 1:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Exercise Set 2: Affirmative Sentences (10 exercises)
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """### Answers - Exercise Set 2:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Exercise Set 3: Negative Sentences (10 exercises)
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """### Answers - Exercise Set 3:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Exercise Set 4: Questions (10 exercises)
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """### Answers - Exercise Set 4:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Exercise Set 5: Short Answers (10 exercises)
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """### Answers - Exercise Set 5:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Exercise Set 6: Time Expressions (10 exercises)

**Instructions:** Complete with irregular verbs and the time expression in parentheses.
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """### Answers - Exercise Set 6:
...
---""", f"cell-{cell_counter}"))
    ...
    # Exercise Set 7: There irregular verbs
    cells.append(create_cell("markdown", """## Exercise Set 7: There Irregular Verbs (10 exercises)
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """### Answers - Exercise Set 7:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Exercise Set 8: Error Correction (10 exercises)
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """### Answers - Exercise Set 8:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Exercise Set 9: Sentence Completion (10 exercises)
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """### Answers - Exercise Set 9:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Exercise Set 10: Mixed Practice - Challenge (10 exercises)

**Instructions:** Translate or create sentences using irregular verbs.
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """### Answers - Exercise Set 10:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Pronunciation Practice 🔊

Listen and repeat these sentences:""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Pronunciation practice
sentences = [
...
for sentence in sentences:
    audio.play_audio(sentence, accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1
...
You've completed **70+ controlled practice exercises** on Past Simple irregular verbs!
...
✅ Using there irregular verbs
✅ Correcting errors
✅ Completing sentences
✅ Mixed practice challenges

### Next Steps:
Continue to **03_meaningful_practice.ipynb** to use irregular verbs in more personalized and creative ways!

---

**Great job!** 🌟 You're making excellent progress!""", f"cell-{cell_counter}"))
    cell_counter += 1
...
if __name__ == "__main__":
    ...
    print(f"Module 17 Phase 2 notebook created successfully!")
