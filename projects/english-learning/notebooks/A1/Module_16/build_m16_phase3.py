"""
Builder script for Module 16 Phase 3: Past Simple - Regular Verbs - Meaningful Practice
...
def build_phase3_notebook():
    ...
    # Title
    cells.append(create_cell("markdown", """# Module 16: Past Simple - Regular Verbs - Meaningful Practice

## 📚 Phase 3: Meaningful Practice (30% of learning time)

**Welcome to Meaningful Practice!** 🎨

In this phase, you'll use Past Simple regular verbs to talk about **YOUR OWN** past experiences. These activities are personal and creative!
...
- Where you were
- Who was there
- What happened (using regular verbs for states)
- How you felt
...
### Key Achievement:
You've used Past Simple regular verbs to tell **YOUR OWN STORIES** in English! This is real communication!
...
if __name__ == "__main__":
    ...
    print(f"Module 16 Phase 3 notebook created successfully!")
