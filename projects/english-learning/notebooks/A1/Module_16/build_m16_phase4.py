"""
Builder script for Module 16 Phase 4: Past Simple - Regular Verbs - Communicative Practice
...
def build_phase4_notebook():
    ...
    # Title
    cells.append(create_cell("markdown", """# Module 16: Past Simple - Regular Verbs - Communicative Practice

## 📚 Phase 4: Communicative Practice (25% of learning time)

**Welcome to Communicative Practice!** 🗣️

In this final phase, you'll use Past Simple regular verbs in **real-world communication tasks**. These activities simulate authentic conversations and situations.
...
print("✅ Setup complete! Let's communicate in English!")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Task 1
    cells.append(create_cell("markdown", """## Task 1: Interview About the Past 🎤
...
### Example Conversation:""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Example interview
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Your Practice:
...
---""", f"cell-{cell_counter}"))
    ...
    # Task 2
    cells.append(create_cell("markdown", """## Task 2: Comparing Then and Now 🔄
...
### Example:""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Example comparison
audio.create_conversation_audio([
...
---""", f"cell-{cell_counter}"))
    ...
    # Task 3
    cells.append(create_cell("markdown", """## Task 3: Telling a Story 📖
...
2. **Middle:** What happened (use regular verbs for descriptions)
3. **End:** How it ended, how you felt

### Example Story:""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Example story
story = '''
...
audio.play_audio(story, accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1
...
---""", f"cell-{cell_counter}"))
    ...
    # Task 4
    cells.append(create_cell("markdown", """## Task 4: Weekend Report 📅
...
- Where you were
- Who you were with
- What you did (use regular verbs for states)
- How the weather was
- How you felt
...
### Example:""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Example weekend report
audio.create_conversation_audio([
...
---""", f"cell-{cell_counter}"))
    ...
    # Task 5
    cells.append(create_cell("markdown", """## Task 5: Describing a Past Event 🎉
...
### Example:""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Example event description
description = '''
...
audio.play_audio(description, accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1
...
---""", f"cell-{cell_counter}"))
    ...
    # Task 6
    cells.append(create_cell("markdown", """## Task 6: Childhood Memories Exchange 👶
...
### Example Exchange:""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Example childhood exchange
audio.create_conversation_audio([
...
---""", f"cell-{cell_counter}"))
    ...
    # Task 7
    cells.append(create_cell("markdown", """## Task 7: Travel Stories 🌍
...
### Example Conversation:""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Example travel conversation
audio.create_conversation_audio([
...
---""", f"cell-{cell_counter}"))
    ...
    # Task 8
    cells.append(create_cell("markdown", """## Task 8: Problem-Solving: What Happened? 🔍
...
**Situation 1: Missed Meeting**""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Example problem-solving 1
audio.create_conversation_audio([
    ...
    cells.append(create_cell("code", """# Example problem-solving 2
audio.create_conversation_audio([
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 🎯 Final Challenge: Extended Conversation
...
---""", f"cell-{cell_counter}"))
    ...
    # Self-Assessment
    cells.append(create_cell("markdown", """## 📊 Self-Assessment
...
## 🎉 Congratulations! Module 16 Complete!

You've successfully completed all four phases of **Past Simple - Regular Verbs**!
...
**Excellent work!** You're making amazing progress! 🚀""", f"cell-{cell_counter}"))
    cell_counter += 1
...
if __name__ == "__main__":
    ...
    print(f"Module 16 Phase 4 notebook created successfully!")
