...
def create_cell(cell_type, content, cell_id):
    ...
    if cell_type == "markdown":
        ...
        return {"cell_type": "code", "execution_count": None, "id": cell_id, "metadata": {}, "outputs": [], "source": content}
...
def build_phase2_notebook():
    ...
    # Title
    cells.append(create_cell("markdown", """# Module 16: Past Simple - Regular Verbs - Controlled Practice
...
print("Setup complete! Let's practice Past Simple!")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Exercise Set 1: Forming Past Simple
    cells.append(create_cell("markdown", """## Exercise Set 1: Forming Past Simple (10 exercises)
...
---""", f"cell-{cell_counter}"))
    ...
    for i in range(3, 11):
        cells.append(create_cell("markdown", f"""## Exercise Set {i}: Practice Set {i} (7-10 exercises)
...
---""", f"cell-{cell_counter}"))
        ...
        cells.append(create_cell("markdown", f"""### Answers - Exercise Set {i}:
...
if __name__ == "__main__":
    ...
    print(f"Module 16 Phase 2 created! Size: {file_size_kb:.2f} KB, Cells: {len(notebook['cells'])}")
