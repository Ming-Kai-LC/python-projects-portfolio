...
def build_phase1_notebook():
    ...
    # Cell 0: Title
    cells.append(create_cell("markdown", """# Module 16: Past Simple - Regular Verbs - Introduction
...
print("✅ Setup complete! Let's learn about Past Simple regular verbs!")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Section 1
    cells.append(create_cell("markdown", """## 1. Introduction to Past Simple Regular Verbs ⏰
...
audio.play_audio("I played football yesterday.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She watched a movie last night.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("We walked in the park.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Section 2: Spelling Rules
    cells.append(create_cell("markdown", """## 2. Spelling Rules for -ed Endings 📝
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Spelling examples
audio.play_audio("I liked the movie.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She studied hard.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("We stopped at the store.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Section 3: Pronunciation
    cells.append(create_cell("markdown", """## 3. Pronunciation of -ed Endings 🔊
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Pronunciation practice - /t/ sound
audio.play_audio("I walked to school.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Pronunciation practice - /d/ sound
audio.play_audio("She played the piano.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Pronunciation practice - /ɪd/ sound
audio.play_audio("We wanted to go home.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Section 4: Affirmative Sentences
    cells.append(create_cell("markdown", """## 4. Affirmative Sentences (Positive Statements) ✅
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Affirmative sentences
audio.play_audio("I played football yesterday.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She cooked dinner last night.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("We visited the museum.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Section 5: Negative Sentences
    cells.append(create_cell("markdown", """## 5. Negative Sentences 🚫
...
---""", f"cell-{cell_counter}"))
    ...
    # Negative examples
    cells.append(create_cell("code", """# Negative sentences
audio.play_audio("I didn't play football yesterday.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She didn't watch the movie.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("They didn't finish their homework.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Section 6: Questions
    cells.append(create_cell("markdown", """## 6. Questions in Past Simple ❓
...
---""", f"cell-{cell_counter}"))
    ...
    # Question examples
    cells.append(create_cell("code", """# Questions
audio.play_audio("Did you play football yesterday?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Where did you go last weekend?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("What did you do yesterday?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Section 7: Short Answers
    cells.append(create_cell("markdown", """## 7. Short Answers 👍👎
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Short answers conversation
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """## 8. Time Expressions with Past Simple 📅
...
---""", f"cell-{cell_counter}"))
    ...
    # Time expressions
    cells.append(create_cell("code", """# Time expressions
audio.play_audio("I visited my grandparents last weekend.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("She called me two hours ago.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Section 9: Common Regular Verbs List
    cells.append(create_cell("markdown", """## 9. Common Regular Verbs (50+ verbs) 📚
...
### Conversation 1: Talking About Yesterday</cell>""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Conversation 1
audio.create_conversation_audio([
    ...
    # Conversation 2
    cells.append(create_cell("markdown", """### Conversation 2: Weekend Activities</cell>""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 2
audio.create_conversation_audio([
    ...
    # Conversation 3
    cells.append(create_cell("markdown", """### Conversation 3: Last Vacation</cell>""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 3
audio.create_conversation_audio([
