...
def create_module_18_notebooks():
    ...
    cells1.append(nbf.v4.new_markdown_cell("""# Module 18: Going To Future - Phase 1: Introduction
...
**Estimated Time:** 90-120 minutes"""))
    ...
    sections = [
        ("1. Introduction to Going To", "The 'going to' future expresses plans, intentions, and predictions based on evidence."),
        ("2. Formation", "Structure: Subject + am/is/are + going to + base verb"),
        ("3. Affirmative Sentences", "I'm going to study. She's going to visit. They're going to travel."),
        ("4. Negative Sentences", "I'm not going to work. She isn't going to come. They aren't going to buy."),
...
print("\\nYour turn: Create 5 sentences using 'going to'")"""))
    ...
    cells2.append(nbf.v4.new_markdown_cell("""# Module 18: Going To Future - Phase 2: Controlled Practice
...
print("\\n[Answers provided at end]")"""))
    ...
    cells3.append(nbf.v4.new_markdown_cell("""# Module 18: Going To Future - Phase 3: Meaningful Practice
...
10. New Year Resolutions"""))
    ...
    activities = [
        "My Future Plans", "Weekend Plans", "Making Predictions",
        "Travel Plans", "Life Goals", "Weather Predictions",
        "Career Plans", "Family Activities", "Event Planning",
        "New Year Resolutions"
    ]

    for i, activity in enumerate(activities, 1):
        cells3.append(nbf.v4.new_markdown_cell(f"""## Activity {i}: {activity}
...
I'm going to [complete this activity]..."""))
        ...
        cells3.append(nbf.v4.new_code_cell(f"""# Activity {i}: {activity}
print("{activity}")
print("=" * 60)
...
print("\\nShare your answers with a partner!")"""))
    ...
    cells4.append(nbf.v4.new_markdown_cell("""# Module 18: Going To Future - Phase 4: Communicative Practice
...
def create_module_19_notebooks():
    ...
    cells1.append(nbf.v4.new_markdown_cell("""# Module 19: Will Future - Phase 1: Introduction
...
**Estimated Time:** 90-120 minutes"""))
    ...
    sections = [
        ("1. Introduction to Will", "Will expresses spontaneous decisions, promises, predictions, and offers."),
...
print("\\nPractice: Create your own sentences with 'will'")"""))
    ...
    nb2 = nbf.v4.new_notebook()
    cells2 = []
    cells2.append(nbf.v4.new_markdown_cell("""# Module 19: Will Future - Phase 2: Controlled Practice

70+ exercises on "will" future"""))

    for i in range(8):
        cells2.append(nbf.v4.new_markdown_cell(f"""## Exercise Set {i+1}

Practice exercises for "will" future"""))
        cells2.append(nbf.v4.new_code_cell(f"""# Exercise set {i+1}
print("Exercises {i*10+1}-{(i+1)*10}")"""))
    ...
    nb3 = nbf.v4.new_notebook()
    cells3 = []
    cells3.append(nbf.v4.new_markdown_cell("""# Module 19: Will Future - Phase 3: Meaningful Practice

10 activities using "will" in context"""))

    for i in range(10):
        cells3.append(nbf.v4.new_markdown_cell(f"""## Activity {i+1}

Meaningful practice activity"""))
        cells3.append(nbf.v4.new_code_cell(f"""# Activity {i+1}
print("Activity {i+1}")"""))
    ...
    nb4 = nbf.v4.new_notebook()
    cells4 = []
    cells4.append(nbf.v4.new_markdown_cell("""# Module 19: Will Future - Phase 4: Communicative Practice

8 communicative tasks"""))

    for i in range(8):
        cells4.append(nbf.v4.new_markdown_cell(f"""## Task {i+1}

Communicative task"""))
        cells4.append(nbf.v4.new_code_cell(f"""# Task {i+1}
print("Task {i+1}")"""))
...
def create_module_20_notebooks():
    ...
    cells1.append(nbf.v4.new_markdown_cell("""# Module 20: Adverbs of Frequency - Extended - Phase 1: Introduction
...
**Estimated Time:** 90-120 minutes"""))
    ...
    sections = [
        ...
        ("4. Percentage Scale", "always=100%, usually=80%, often=60%, sometimes=40%, rarely=20%, never=0%"),
...
print("\\nPractice: Write about your routines")"""))
    ...
    # Similar structure for Phases 2, 3, 4
    for phase_num, phase_name in [(2, "Controlled Practice"), (3, "Meaningful Practice"), (4, "Communicative Practice")]:
        nb = nbf.v4.new_notebook()
        cells = []
        cells.append(nbf.v4.new_markdown_cell(f"""# Module 20: Adverbs of Frequency - Phase {phase_num}: {phase_name}"""))

        num_sections = 8 if phase_num in [2, 4] else 10
        for i in range(num_sections):
            cells.append(nbf.v4.new_markdown_cell(f"""## Section {i+1}

Content for {phase_name}"""))
            cells.append(nbf.v4.new_code_cell(f"""# Section {i+1}
print("Section {i+1}")"""))

        nb['cells'] = cells
        with open(f'Module_20/0{phase_num}_{phase_name.lower().replace(" ", "_")}.ipynb', 'w', encoding='utf-8') as f:
            nbf.write(nb, f)
    ...
    for module_num in [18, 19, 20]:
        ...
        if os.path.exists(module_name):
            ...
            for phase_num in range(1, 5):
                phase_names = ["introduction", "controlled_practice", "meaningful_practice", "communicative_practice"]
