...
def build_phase1_notebook():
    ...
    cells.append(create_cell("markdown", """# Module 13: This, That, These, Those - Introduction
...
---""", f"cell-{cell_counter}"))
    ...
    # Cell 1: Setup
    cells.append(create_cell("code", """# Setup: Import utilities
import sys
...
print("[OK] Setup complete! Let's learn about demonstratives.")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 2: Section 1 - What are Demonstratives (Overview Table)
    cells.append(create_cell("markdown", """## 1. What are Demonstratives? 👉
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 2. THIS - Singular, Near (One Thing Close to You) 👆
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# THIS - Examples with audio
audio.play_audio("This book is very interesting.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("This is my new phone.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("This coffee tastes great.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("This is my friend Sarah.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 8: Section 3 - THAT (Singular, Far)
    cells.append(create_cell("markdown", """## 3. THAT - Singular, Far (One Thing Away from You) 👉
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# THAT - Examples with audio
audio.play_audio("That building is very tall.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("That is a great idea.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("That car over there is mine.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("That was an amazing movie.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 13: Section 4 - THESE (Plural, Near)
    cells.append(create_cell("markdown", """## 4. THESE - Plural, Near (Multiple Things Close to You) 👆👆
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# THESE - Examples with audio
audio.play_audio("These books are very interesting.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("These are my favorite shoes.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("These cookies taste amazing.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("These are my colleagues from work.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 18: Section 5 - THOSE (Plural, Far)
    cells.append(create_cell("markdown", """## 5. THOSE - Plural, Far (Multiple Things Away from You) 👉👉
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# THOSE - Examples with audio
audio.play_audio("Those mountains are very beautiful.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Those are my favorite restaurants.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Those people over there are my friends.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Those were the best days of my life.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 23: Section 6 - Distance Concepts
    cells.append(create_cell("markdown", """## 6. Distance Concepts (Physical vs Abstract) 📏
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Distance concepts - Time examples
audio.play_audio("This week has been very busy.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("That day was the happiest day of my life.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("These days I feel very energetic.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Those were difficult times for everyone.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 28: Section 7 - Using With/Without Nouns
    cells.append(create_cell("markdown", """## 7. Using Demonstratives With and Without Nouns 📝
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# With and without nouns
audio.play_audio("This coffee is delicious. I love this.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Those shoes are beautiful. I want those.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("What is this? This is a new phone.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 32: Section 8 - Questions with Demonstratives
    cells.append(create_cell("markdown", """## 8. Questions with Demonstratives ❓
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Questions with demonstratives
audio.play_audio("What is this? This is my new phone.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Whose are these keys? These are mine.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Which do you prefer, this one or that one?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Are those your books? Yes, those are mine.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 37: Section 9 - Time References
    cells.append(create_cell("markdown", """## 9. Time References (This week, That day) 🗓️
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Time references - THIS
audio.play_audio("I'm very busy this week.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("This morning I went to the gym.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Time references - THAT
audio.play_audio("That day was the best day of my life.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.play_audio("Those were happy times.", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 42: Section 10 - Phone Conversation Uses
    cells.append(create_cell("markdown", """## 10. Phone Conversation Uses ("This is John calling") 📞
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Phone conversation examples
audio.create_conversation_audio([
    ("Person A", "Hello?"),
    ("Person B", "Hi, this is John. Is Sarah there?"),
    ("Person A", "Yes, this is Sarah speaking!")
], accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """audio.create_conversation_audio([
    ...
    cells.append(create_cell("code", """audio.play_audio("Hello, this is Dr. Smith's office. How may I help you?", accent="us")""", f"cell-{cell_counter}"))
    cell_counter += 1

    # Cell 47: Section 11 - Common Mistakes
    cells.append(create_cell("markdown", """## 11. Common Mistakes to Avoid Warning:
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 12. Practice Conversations 🗣️

Let's see demonstratives in action through natural conversations!

### Conversation 1: Shopping at a Store 🛍️</cell>""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 1: Shopping
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 2: At a Museum 🎨""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 2: Museum
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 3: Looking at Photos 📷""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 3: Photos
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 4: In a Restaurant 🍽️""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 4: Restaurant
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 5: Meeting Someone New 👋""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 5: Introductions
audio.create_conversation_audio([
    ...
    cells.append(create_cell("markdown", """### Conversation 6: Phone Call 📱""", f"cell-{cell_counter}"))
    cell_counter += 1

    cells.append(create_cell("code", """# Conversation 6: Phone call
audio.create_conversation_audio([
    ("Person A", "Hello?"),
    ...
    cells.append(create_cell("code", """# Display pronunciation guide
create_pronunciation_guide()""", f"cell-{cell_counter}"))
    cell_counter += 1
...
Ready for practice? Open **02_controlled_practice.ipynb**""", f"cell-{cell_counter}"))
    cell_counter += 1
...
def main():
    ...
    if 18 <= file_size_kb <= 22:
        ...
        print(f"Warning: File size is outside target range. Target: 18-22 KB, Actual: {file_size_kb:.2f} KB")
