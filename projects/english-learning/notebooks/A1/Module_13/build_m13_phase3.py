...
def build_phase3_notebook():
    ...
    cells.append(create_cell("markdown", """# Module 13: This, That, These, Those - Meaningful Practice
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 1: Describe Objects Around You (Near vs Far) 🏠
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 2: Your Workspace Description 💼
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 3: Shopping Scenario (Pointing to Items) 🛍️
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 4: Photo Description (This Person, Those Buildings) 📷
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 5: Time in Your Life (This Week's Plans) 🗓️
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 6: Comparing Near and Far Items ⚖️
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 7: Phone Conversation Practice 📞
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 8: Past vs Present Situations 🔄
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 9: Your Opinions (This Idea, That Suggestion) 💭
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Activity 10: Personal Narrative Using Demonstratives 📖
...
def main():
    ...
    if 16 <= file_size_kb <= 20:
        ...
        print(f"Warning: File size is outside target range. Target: 16-20 KB, Actual: {file_size_kb:.2f} KB")
