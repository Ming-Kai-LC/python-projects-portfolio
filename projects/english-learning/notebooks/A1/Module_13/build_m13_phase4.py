...
def build_phase4_notebook():
    ...
    cells.append(create_cell("markdown", """# Module 13: This, That, These, Those - Communicative Practice
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Task 1: Shopping Dialogue (Customer Pointing to Items) 🛍️
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Task 2: Museum Tour Guide Scenario 🎨
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Task 3: Real Estate Showing 🏠
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Task 4: Restaurant Ordering 🍽️
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Task 5: Tech Store Assistance 💻
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Task 6: Photo Album Sharing 📷
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Task 7: City Tour Conversation 🏙️
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## Task 8: Office Orientation 🏢
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("markdown", """## 🔄 Spaced Repetition Setup
...
---""", f"cell-{cell_counter}"))
    ...
    cells.append(create_cell("code", """# Setup spaced repetition
import sys
...
print("📅 Check your calendar above for review dates.")""", f"cell-{cell_counter}"))
    cell_counter += 1
