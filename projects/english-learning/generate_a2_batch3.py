...
**Focus:** {', '.join(module_data['key_uses'])}"""
        ...
        overview = f"""10 personalized activities using {module_data['modal_focus']} in real contexts"""
    else:  # phase 4
        overview = f"""8 real-world communicative tasks focusing on {', '.join(module_data['key_uses'])}"""
