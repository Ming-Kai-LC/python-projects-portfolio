...
try:
    sample_income = [
        {'date': '2025-01-01', 'category': 'Salary', 'amount': 4500.00, 'description': 'Monthly salary'},
        {'date': '2025-02-01', 'category': 'Salary', 'amount': 4500.00, 'description': 'Monthly salary'},
    ]
...
try:
    ...
    print(f"✅ Search works - Found {len(food_expenses)} food expenses, {len(expensive)} expenses ≥ $45")
except Exception as e:
