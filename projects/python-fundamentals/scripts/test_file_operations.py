    ...
    def test_csv_reading(self):
        ...
        try:
            ...
            if expected_fields != actual_fields:
                raise ValueError(f"CSV structure mismatch. Expected: {expected_fields}, Got: {actual_fields}")
    ...
    def test_json_reading(self):
        ...
        try:
            ...
            if not required_keys.issubset(actual_keys):
                raise ValueError(f"JSON structure incomplete. Missing: {required_keys - actual_keys}")
